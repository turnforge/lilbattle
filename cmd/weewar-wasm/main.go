...
func createGame(this js.Value, args []js.Value) interface{} {
	...
	return createJSResponse(true, fmt.Sprintf("Game created with %d players", playerCount), "", map[string]interface{}{
...
func loadGame(this js.Value, args []js.Value) interface{} {
	if len(args) < 1 {
	...
	return createJSResponse(true, "Game loaded successfully", "", map[string]interface{}{
...
func getGameState(this js.Value, args []js.Value) interface{} {
	...
	for i := 0; i < game.PlayerCount; i++ {
		...
		playerInfo[fmt.Sprintf("player%d", i)] = map[string]interface{}{
			"unitCount": len(units),
		}
	}
...
func renderGame(this js.Value, args []js.Value) interface{} {
	if globalCLI == nil {
		return createJSResponse(false, "", "No game loaded", nil)
	}
	...
	return createJSResponse(true, "Game rendered successfully", "", map[string]interface{}{
		"dataURL": dataURL,
		"width":   width,
		"height":  height,
	})
...
func saveGame(this js.Value, args []js.Value) interface{} {
	if globalCLI == nil {
		return createJSResponse(false, "", "No game loaded", nil)
	}
	...
	return createJSResponse(true, "Game saved successfully", "", map[string]interface{}{
...
func setVerbose(this js.Value, args []js.Value) interface{} {
	if globalCLI == nil {
		return createJSResponse(false, "", "No game loaded", nil)
	}
...
func setDisplayMode(this js.Value, args []js.Value) interface{} {
	if globalCLI == nil {
		return createJSResponse(false, "", "No game loaded", nil)
	}
...
func createJSResponse(success bool, message, error string, data interface{}) js.Value {
	response := JSResponse{
		Success: success,
		Message: message,
		Error:   error,
