...
class GameViewPresenterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.InitializeGame = channel.unary_unary(
                ...
                request_serializer=weewar_dot_v1_dot_presenter__pb2.InitializeGameRequest.SerializeToString,
                response_deserializer=weewar_dot_v1_dot_presenter__pb2.InitializeGameResponse.FromString,
                _registered_method=True)
        self.SceneClicked = channel.unary_unary(
                '/weewar.v1.GameViewPresenter/SceneClicked',
                request_serializer=weewar_dot_v1_dot_presenter__pb2.SceneClickedRequest.SerializeToString,
                response_deserializer=weewar_dot_v1_dot_presenter__pb2.SceneClickedResponse.FromString,
                _registered_method=True)
...
def add_GameViewPresenterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'InitializeGame': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=weewar_dot_v1_dot_presenter__pb2.InitializeGameRequest.FromString,
                    response_serializer=weewar_dot_v1_dot_presenter__pb2.InitializeGameResponse.SerializeToString,
            ),
            'SceneClicked': grpc.unary_unary_rpc_method_handler(
                    servicer.SceneClicked,
                    request_deserializer=weewar_dot_v1_dot_presenter__pb2.SceneClickedRequest.FromString,
                    response_serializer=weewar_dot_v1_dot_presenter__pb2.SceneClickedResponse.SerializeToString,
            ),
...
class GameViewPresenter(object):
    ...
    def InitializeGame(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/weewar.v1.GameViewPresenter/InitializeGame',
            weewar_dot_v1_dot_presenter__pb2.InitializeGameRequest.SerializeToString,
            weewar_dot_v1_dot_presenter__pb2.InitializeGameResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SceneClicked(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/weewar.v1.GameViewPresenter/SceneClicked',
            weewar_dot_v1_dot_presenter__pb2.SceneClickedRequest.SerializeToString,
            weewar_dot_v1_dot_presenter__pb2.SceneClickedResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
