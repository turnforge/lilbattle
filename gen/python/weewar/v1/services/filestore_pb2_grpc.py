...
class FileStoreServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PutFile = channel.unary_unary(
                '/weewar.v1.FileStoreService/PutFile',
                request_serializer=weewar_dot_v1_dot_models_dot_filestore__pb2.PutFileRequest.SerializeToString,
                response_deserializer=weewar_dot_v1_dot_models_dot_filestore__pb2.PutFileResponse.FromString,
                _registered_method=True)
        self.GetFile = channel.unary_unary(
                '/weewar.v1.FileStoreService/GetFile',
                request_serializer=weewar_dot_v1_dot_models_dot_filestore__pb2.GetFileRequest.SerializeToString,
                response_deserializer=weewar_dot_v1_dot_models_dot_filestore__pb2.GetFileResponse.FromString,
                _registered_method=True)
...
def add_FileStoreServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PutFile': grpc.unary_unary_rpc_method_handler(
                    servicer.PutFile,
                    request_deserializer=weewar_dot_v1_dot_models_dot_filestore__pb2.PutFileRequest.FromString,
                    response_serializer=weewar_dot_v1_dot_models_dot_filestore__pb2.PutFileResponse.SerializeToString,
            ),
            'GetFile': grpc.unary_unary_rpc_method_handler(
                    servicer.GetFile,
                    request_deserializer=weewar_dot_v1_dot_models_dot_filestore__pb2.GetFileRequest.FromString,
                    response_serializer=weewar_dot_v1_dot_models_dot_filestore__pb2.GetFileResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'weewar.v1.FileStoreService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('weewar.v1.FileStoreService', rpc_method_handlers)
...
class FileStoreService(object):
    ...
    def PutFile(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/weewar.v1.FileStoreService/PutFile',
            weewar_dot_v1_dot_models_dot_filestore__pb2.PutFileRequest.SerializeToString,
            weewar_dot_v1_dot_models_dot_filestore__pb2.PutFileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetFile(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/weewar.v1.FileStoreService/GetFile',
            weewar_dot_v1_dot_models_dot_filestore__pb2.GetFileRequest.SerializeToString,
            weewar_dot_v1_dot_models_dot_filestore__pb2.GetFileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
