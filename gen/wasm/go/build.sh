...
# Build script for weewar WASM module

set -e

echo "Building weewar WASM module..."
...
go build -o weewar.wasm weewar.wasm.go
...
echo '  WebAssembly.instantiateStreaming(fetch("weewar.wasm"), go.importObject)'
