...
func (exports *ServicesServicesExports) RegisterAPI() {
	fmt.Println("services WASM module loading...")
	...
	fmt.Println("services WASM module loaded successfully")
}
...
func (exports *ServicesServicesExports) coordinatorServiceSubmitProposal(this js.Value, args []js.Value) any {
...
func (exports *ServicesServicesExports) coordinatorServiceGetPendingValidations(this js.Value, args []js.Value) any {
	if exports.CoordinatorService == nil {
		return createJSResponse(false, "CoordinatorService not initialized", nil)
	}
	// Synchronous method
...
func (exports *ServicesServicesExports) coordinatorServiceSubmitValidation(this js.Value, args []js.Value) any {
	if exports.CoordinatorService == nil {
		return createJSResponse(false, "CoordinatorService not initialized", nil)
	}
	// Synchronous method
...
func (exports *ServicesServicesExports) coordinatorServiceGetProposalStatus(this js.Value, args []js.Value) any {
	if exports.CoordinatorService == nil {
		return createJSResponse(false, "CoordinatorService not initialized", nil)
	}
	// Synchronous method
