...
const (
	...
	FileStoreServiceName = "weewar.v1.FileStoreService"
)
...
const (
	...
	// RPC.
	FileStoreServicePutFileProcedure = "/weewar.v1.FileStoreService/PutFile"
	// FileStoreServiceGetFileProcedure is the fully-qualified name of the FileStoreService's GetFile
	// RPC.
	FileStoreServiceGetFileProcedure = "/weewar.v1.FileStoreService/GetFile"
...
func NewFileStoreServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FileStoreServiceClient {
	...
	fileStoreServiceMethods := services.File_weewar_v1_services_filestore_proto.Services().ByName("FileStoreService").Methods()
...
// GetFile calls weewar.v1.FileStoreService.GetFile.
...
// DeleteFile calls weewar.v1.FileStoreService.DeleteFile.
...
func (UnimplementedFileStoreServiceHandler) PutFile(context.Context, *connect.Request[models.PutFileRequest]) (*connect.Response[models.PutFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("weewar.v1.FileStoreService.PutFile is not implemented"))
}
...
func (UnimplementedFileStoreServiceHandler) GetFile(context.Context, *connect.Request[models.GetFileRequest]) (*connect.Response[models.GetFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("weewar.v1.FileStoreService.GetFile is not implemented"))
}
