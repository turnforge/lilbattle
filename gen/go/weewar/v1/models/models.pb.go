...
// 	protoc        (unknown)
// source: weewar/v1/models/models.proto
...
func (CrossingType) Descriptor() protoreflect.EnumDescriptor {
	return file_weewar_v1_models_models_proto_enumTypes[0].Descriptor()
}

func (CrossingType) Type() protoreflect.EnumType {
	return &file_weewar_v1_models_models_proto_enumTypes[0]
}
...
func (CrossingType) EnumDescriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{0}
}
...
func (TerrainType) Descriptor() protoreflect.EnumDescriptor {
	return file_weewar_v1_models_models_proto_enumTypes[1].Descriptor()
}

func (TerrainType) Type() protoreflect.EnumType {
	return &file_weewar_v1_models_models_proto_enumTypes[1]
}
...
func (TerrainType) EnumDescriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{1}
}
...
func (GameStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_weewar_v1_models_models_proto_enumTypes[2].Descriptor()
}

func (GameStatus) Type() protoreflect.EnumType {
	return &file_weewar_v1_models_models_proto_enumTypes[2]
}
...
func (GameStatus) EnumDescriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{2}
}
...
func (PathDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_weewar_v1_models_models_proto_enumTypes[3].Descriptor()
}

func (PathDirection) Type() protoreflect.EnumType {
	return &file_weewar_v1_models_models_proto_enumTypes[3]
}
...
func (PathDirection) EnumDescriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{3}
}
...
func (x *IndexInfo) Reset() {
	*x = IndexInfo{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[0]
...
func (x *User) Reset() {
	*x = User{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Pagination) Reset() {
	*x = Pagination{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *PaginationResponse) Reset() {
	*x = PaginationResponse{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *World) Reset() {
	*x = World{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*World) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{4}
}
...
func (x *WorldData) Reset() {
	*x = WorldData{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorldData) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{5}
}
...
type Crossing struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Type  CrossingType           `protobuf:"varint,1,opt,name=type,proto3,enum=weewar.v1.CrossingType" json:"type,omitempty"`
...
func (x *Crossing) Reset() {
	*x = Crossing{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Crossing) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{6}
}
...
func (x *Tile) Reset() {
	*x = Tile{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Tile) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{7}
}
...
func (x *Unit) Reset() {
	*x = Unit{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Unit) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{8}
}
...
func (x *AttackRecord) Reset() {
	*x = AttackRecord{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttackRecord) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{9}
}
...
func (x *TerrainDefinition) Reset() {
	*x = TerrainDefinition{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TerrainDefinition) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{10}
}
...
func (x *UnitDefinition) Reset() {
	*x = UnitDefinition{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnitDefinition) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{11}
}
...
func (x *TerrainUnitProperties) Reset() {
	*x = TerrainUnitProperties{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TerrainUnitProperties) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{12}
}
...
func (x *UnitUnitProperties) Reset() {
	*x = UnitUnitProperties{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnitUnitProperties) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{13}
}
...
func (x *DamageDistribution) Reset() {
	*x = DamageDistribution{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DamageDistribution) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{14}
}
...
func (x *DamageRange) Reset() {
	*x = DamageRange{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DamageRange) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{15}
}
...
type RulesEngine struct {
	...
	TerrainTypes  map[int32]TerrainType `protobuf:"bytes,5,rep,name=terrain_types,json=terrainTypes,proto3" json:"terrain_types,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value,enum=weewar.v1.TerrainType"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RulesEngine) Reset() {
	*x = RulesEngine{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RulesEngine) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{16}
}
...
func (x *Game) Reset() {
	*x = Game{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GameConfiguration) Reset() {
	*x = GameConfiguration{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GameConfiguration) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{18}
}
...
func (x *IncomeConfig) Reset() {
	*x = IncomeConfig{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IncomeConfig) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{19}
}
...
func (x *GamePlayer) Reset() {
	*x = GamePlayer{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GamePlayer) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{20}
}
...
func (x *GameTeam) Reset() {
	*x = GameTeam{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GameTeam) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{21}
}
...
func (x *GameSettings) Reset() {
	*x = GameSettings{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GameSettings) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{22}
}
...
func (x *TileCapturedChange) Reset() {
	*x = TileCapturedChange{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TileCapturedChange) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{43}
}
...
func (x *CaptureStartedChange) Reset() {
	*x = CaptureStartedChange{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CaptureStartedChange) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{44}
}
...
func (x *AllPaths) Reset() {
	*x = AllPaths{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AllPaths) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{45}
}
...
func (x *PathEdge) Reset() {
	*x = PathEdge{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PathEdge) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{46}
}
...
func (x *Path) Reset() {
	*x = Path{}
	mi := &file_weewar_v1_models_models_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Path) Descriptor() ([]byte, []int) {
	return file_weewar_v1_models_models_proto_rawDescGZIP(), []int{47}
}
...
var File_weewar_v1_models_models_proto protoreflect.FileDescriptor

const file_weewar_v1_models_models_proto_rawDesc = "" +
	"\n" +
	"\x1dweewar/v1/models/models.proto\x12\tweewar.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xba\x01\n" +
	"\tIndexInfo\x12B\n" +
	...
	"\x0eneeds_indexing\x18\x03 \x01(\bR\rneedsIndexing\"\x93\x02\n" +
	"\x04User\x129\n" +
	"\n" +
	...
	"\x11search_index_info\x18\r \x01(\v2\x14.weewar.v1.IndexInfoR\x0fsearchIndexInfo\"\xc6\x04\n" +
	"\tWorldData\x12?\n" +
	"\ttiles_map\x18\x01 \x03(\v2\".weewar.v1.WorldData.TilesMapEntryR\btilesMap\x12?\n" +
	"\tunits_map\x18\x02 \x03(\v2\".weewar.v1.WorldData.UnitsMapEntryR\bunitsMap\x12H\n" +
	...
	"\aversion\x18\x05 \x01(\x03R\aversion\x12A\n" +
	"\tcrossings\x18\b \x03(\v2#.weewar.v1.WorldData.CrossingsEntryR\tcrossings\x1aL\n" +
	"\rTilesMapEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12%\n" +
	"\x05value\x18\x02 \x01(\v2\x0f.weewar.v1.TileR\x05value:\x028\x01\x1aL\n" +
	"\rUnitsMapEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12%\n" +
	"\x05value\x18\x02 \x01(\v2\x0f.weewar.v1.UnitR\x05value:\x028\x01\x1aQ\n" +
	"\x0eCrossingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.weewar.v1.CrossingR\x05value:\x028\x01\"X\n" +
	"\bCrossing\x12+\n" +
	"\x04type\x18\x01 \x01(\x0e2\x17.weewar.v1.CrossingTypeR\x04type\x12\x1f\n" +
	...
	"\x12last_toppedup_turn\x18\a \x01(\x05R\x10lastToppedupTurn\"\xa2\x04\n" +
	"\x04Unit\x12\f\n" +
	"\x01q\x18\x01 \x01(\x05R\x01q\x12\f\n" +
	...
	"\x0fattack_vs_class\x18\x10 \x03(\v2,.weewar.v1.UnitDefinition.AttackVsClassEntryR\rattackVsClass\x12!\n" +
	"\faction_order\x18\x11 \x03(\tR\vactionOrder\x12P\n" +
	"\raction_limits\x18\x12 \x03(\v2+.weewar.v1.UnitDefinition.ActionLimitsEntryR\factionLimits\x1af\n" +
	...
	"\x10defense_override\x18\x04 \x01(\x05H\x01R\x0fdefenseOverride\x88\x01\x01\x125\n" +
	"\x06damage\x18\x05 \x01(\v2\x1d.weewar.v1.DamageDistributionR\x06damageB\x12\n" +
	...
	"\vprobability\x18\x03 \x01(\x01R\vprobability\"\xff\x06\n" +
	"\vRulesEngine\x127\n" +
	...
	"\x14unit_unit_properties\x18\x04 \x03(\v2..weewar.v1.RulesEngine.UnitUnitPropertiesEntryR\x12unitUnitProperties\x12M\n" +
	"\rterrain_types\x18\x05 \x03(\v2(.weewar.v1.RulesEngine.TerrainTypesEntryR\fterrainTypes\x1aS\n" +
	"\n" +
	"UnitsEntry\x12\x10\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x1d.weewar.v1.UnitUnitPropertiesR\x05value:\x028\x01\x1aW\n" +
	"\x11TerrainTypesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\x0e2\x16.weewar.v1.TerrainTypeR\x05value:\x028\x01\"\x82\x04\n" +
	"\x04Game\x129\n" +
	"\n" +
	"created_at\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	...
	"\n" +
	"world_data\x18\x06 \x01(\v2\x14.weewar.v1.WorldDataR\tworldData\x12\x1d\n" +
	"\n" +
	...
	"\x05moves\x18\x05 \x03(\v2\x13.weewar.v1.GameMoveR\x05moves\"\xbe\x05\n" +
	"\bGameMove\x12\x16\n" +
	...
	"\tmove_unit\x18\x05 \x01(\v2\x19.weewar.v1.MoveUnitActionH\x00R\bmoveUnit\x12>\n" +
	"\vattack_unit\x18\x06 \x01(\v2\x1b.weewar.v1.AttackUnitActionH\x00R\n" +
	"attackUnit\x125\n" +
	"\bend_turn\x18\a \x01(\v2\x18.weewar.v1.EndTurnActionH\x00R\aendTurn\x12;\n" +
	"\n" +
	"build_unit\x18\b \x01(\v2\x1a.weewar.v1.BuildUnitActionH\x00R\tbuildUnit\x12M\n" +
	"\x10capture_building\x18\r \x01(\v2 .weewar.v1.CaptureBuildingActionH\x00R\x0fcaptureBuilding\x128\n" +
	"\theal_unit\x18\x0e \x01(\v2\x19.weewar.v1.HealUnitActionH\x00R\bhealUnit\x12!\n" +
	...
	"\x01r\x18\x03 \x01(\x05R\x01r\"\xc3\x01\n" +
	"\x0eMoveUnitAction\x12'\n" +
	"\x04from\x18\x01 \x01(\v2\x13.weewar.v1.PositionR\x04from\x12#\n" +
	"\x02to\x18\x02 \x01(\v2\x13.weewar.v1.PositionR\x02to\x12#\n" +
	"\rmovement_cost\x18\x03 \x01(\x01R\fmovementCost\x12>\n" +
	"\x12reconstructed_path\x18\x04 \x01(\v2\x0f.weewar.v1.PathR\x11reconstructedPath\"\x94\x02\n" +
	"\x10AttackUnitAction\x12/\n" +
	"\battacker\x18\x01 \x01(\v2\x13.weewar.v1.PositionR\battacker\x12/\n" +
	"\bdefender\x18\x02 \x01(\v2\x13.weewar.v1.PositionR\bdefender\x12(\n" +
	...
	" \x01(\x05R\x0edamageEstimate\"i\n" +
	"\x0fBuildUnitAction\x12%\n" +
	"\x03pos\x18\x01 \x01(\v2\x13.weewar.v1.PositionR\x03pos\x12\x1b\n" +
	...
	"\x03pos\x18\x01 \x01(\v2\x13.weewar.v1.PositionR\x03pos\x12\x1f\n" +
	...
	"unitKilled\x12G\n" +
	"\x0eplayer_changed\x18\x04 \x01(\v2\x1e.weewar.v1.PlayerChangedChangeH\x00R\rplayerChanged\x12;\n" +
	"\n" +
	"unit_built\x18\x05 \x01(\v2\x1a.weewar.v1.UnitBuiltChangeH\x00R\tunitBuilt\x12D\n" +
	"\rcoins_changed\x18\x06 \x01(\v2\x1d.weewar.v1.CoinsChangedChangeH\x00R\fcoinsChanged\x12D\n" +
	"\rtile_captured\x18\a \x01(\v2\x1d.weewar.v1.TileCapturedChangeH\x00R\ftileCaptured\x12J\n" +
	"\x0fcapture_started\x18\b \x01(\v2\x1f.weewar.v1.CaptureStartedChangeH\x00R\x0ecaptureStarted\x12>\n" +
	"\vunit_healed\x18\t \x01(\v2\x1b.weewar.v1.UnitHealedChangeH\x00R\n" +
	"unitHealedB\r\n" +
	"\vchange_type\"\x9d\x01\n" +
	"\x10UnitHealedChange\x124\n" +
	"\rprevious_unit\x18\x01 \x01(\v2\x0f.weewar.v1.UnitR\fpreviousUnit\x122\n" +
	"\fupdated_unit\x18\x02 \x01(\v2\x0f.weewar.v1.UnitR\vupdatedUnit\x12\x1f\n" +
	...
	"\x04unit\x18\x01 \x01(\v2\x0f.weewar.v1.UnitR\x04unit\x12\x15\n" +
	...
	"\x12TileCapturedChange\x126\n" +
	"\x0ecapturing_unit\x18\x01 \x01(\v2\x0f.weewar.v1.UnitR\rcapturingUnit\x12\x15\n" +
	"\x06tile_q\x18\x02 \x01(\x05R\x05tileQ\x12\x15\n" +
	...
	"\tnew_owner\x18\x06 \x01(\x05R\bnewOwner\"\xbe\x01\n" +
	"\x14CaptureStartedChange\x126\n" +
	"\x0ecapturing_unit\x18\x01 \x01(\v2\x0f.weewar.v1.UnitR\rcapturingUnit\x12\x15\n" +
	"\x06tile_q\x18\x02 \x01(\x05R\x05tileQ\x12\x15\n" +
	"\x06tile_r\x18\x03 \x01(\x05R\x05tileR\x12\x1b\n" +
	"\ttile_type\x18\x04 \x01(\x05R\btileType\x12#\n" +
	"\rcurrent_owner\x18\x05 \x01(\x05R\fcurrentOwner\"\xc5\x01\n" +
	"\bAllPaths\x12\x19\n" +
	...
	"EdgesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.weewar.v1.PathEdgeR\x05value:\x028\x01\"\x88\x02\n" +
	"\bPathEdge\x12\x15\n" +
...
var (
	file_weewar_v1_models_models_proto_rawDescOnce sync.Once
	file_weewar_v1_models_models_proto_rawDescData []byte
)

func file_weewar_v1_models_models_proto_rawDescGZIP() []byte {
	file_weewar_v1_models_models_proto_rawDescOnce.Do(func() {
		file_weewar_v1_models_models_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_weewar_v1_models_models_proto_rawDesc), len(file_weewar_v1_models_models_proto_rawDesc)))
	})
	return file_weewar_v1_models_models_proto_rawDescData
}

var file_weewar_v1_models_models_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_weewar_v1_models_models_proto_msgTypes = make([]protoimpl.MessageInfo, 62)
var file_weewar_v1_models_models_proto_goTypes = []any{
	...
	(GameStatus)(0),               // 2: weewar.v1.GameStatus
	(PathDirection)(0),            // 3: weewar.v1.PathDirection
	(*IndexInfo)(nil),             // 4: weewar.v1.IndexInfo
	(*User)(nil),                  // 5: weewar.v1.User
	(*Pagination)(nil),            // 6: weewar.v1.Pagination
	(*PaginationResponse)(nil),    // 7: weewar.v1.PaginationResponse
	(*World)(nil),                 // 8: weewar.v1.World
	(*WorldData)(nil),             // 9: weewar.v1.WorldData
	(*Crossing)(nil),              // 10: weewar.v1.Crossing
	(*Tile)(nil),                  // 11: weewar.v1.Tile
	(*Unit)(nil),                  // 12: weewar.v1.Unit
	(*AttackRecord)(nil),          // 13: weewar.v1.AttackRecord
	(*TerrainDefinition)(nil),     // 14: weewar.v1.TerrainDefinition
	(*UnitDefinition)(nil),        // 15: weewar.v1.UnitDefinition
	(*TerrainUnitProperties)(nil), // 16: weewar.v1.TerrainUnitProperties
	(*UnitUnitProperties)(nil),    // 17: weewar.v1.UnitUnitProperties
	(*DamageDistribution)(nil),    // 18: weewar.v1.DamageDistribution
	(*DamageRange)(nil),           // 19: weewar.v1.DamageRange
	(*RulesEngine)(nil),           // 20: weewar.v1.RulesEngine
	(*Game)(nil),                  // 21: weewar.v1.Game
	(*GameConfiguration)(nil),     // 22: weewar.v1.GameConfiguration
	(*IncomeConfig)(nil),          // 23: weewar.v1.IncomeConfig
	...
	(*Position)(nil),              // 32: weewar.v1.Position
	(*MoveUnitAction)(nil),        // 33: weewar.v1.MoveUnitAction
	(*AttackUnitAction)(nil),      // 34: weewar.v1.AttackUnitAction
	(*BuildUnitAction)(nil),       // 35: weewar.v1.BuildUnitAction
	(*CaptureBuildingAction)(nil), // 36: weewar.v1.CaptureBuildingAction
	(*EndTurnAction)(nil),         // 37: weewar.v1.EndTurnAction
	(*HealUnitAction)(nil),        // 38: weewar.v1.HealUnitAction
	(*WorldChange)(nil),           // 39: weewar.v1.WorldChange
	(*UnitHealedChange)(nil),      // 40: weewar.v1.UnitHealedChange
	(*UnitMovedChange)(nil),       // 41: weewar.v1.UnitMovedChange
	(*UnitDamagedChange)(nil),     // 42: weewar.v1.UnitDamagedChange
	(*UnitKilledChange)(nil),      // 43: weewar.v1.UnitKilledChange
	(*PlayerChangedChange)(nil),   // 44: weewar.v1.PlayerChangedChange
	(*UnitBuiltChange)(nil),       // 45: weewar.v1.UnitBuiltChange
	(*CoinsChangedChange)(nil),    // 46: weewar.v1.CoinsChangedChange
	(*TileCapturedChange)(nil),    // 47: weewar.v1.TileCapturedChange
	(*CaptureStartedChange)(nil),  // 48: weewar.v1.CaptureStartedChange
	(*AllPaths)(nil),              // 49: weewar.v1.AllPaths
	(*PathEdge)(nil),              // 50: weewar.v1.PathEdge
	(*Path)(nil),                  // 51: weewar.v1.Path
	nil,                           // 52: weewar.v1.WorldData.TilesMapEntry
	nil,                           // 53: weewar.v1.WorldData.UnitsMapEntry
	nil,                           // 54: weewar.v1.WorldData.CrossingsEntry
	nil,                           // 55: weewar.v1.TerrainDefinition.UnitPropertiesEntry
	nil,                           // 56: weewar.v1.UnitDefinition.TerrainPropertiesEntry
	nil,                           // 57: weewar.v1.UnitDefinition.AttackVsClassEntry
	nil,                           // 58: weewar.v1.UnitDefinition.ActionLimitsEntry
	nil,                           // 59: weewar.v1.RulesEngine.UnitsEntry
	nil,                           // 60: weewar.v1.RulesEngine.TerrainsEntry
	nil,                           // 61: weewar.v1.RulesEngine.TerrainUnitPropertiesEntry
	nil,                           // 62: weewar.v1.RulesEngine.UnitUnitPropertiesEntry
	nil,                           // 63: weewar.v1.RulesEngine.TerrainTypesEntry
	nil,                           // 64: weewar.v1.GameState.PlayerStatesEntry
	nil,                           // 65: weewar.v1.AllPaths.EdgesEntry
	(*timestamppb.Timestamp)(nil), // 66: google.protobuf.Timestamp
}
var file_weewar_v1_models_models_proto_depIdxs = []int32{
	66, // 0: weewar.v1.IndexInfo.last_updated_at:type_name -> google.protobuf.Timestamp
	66, // 1: weewar.v1.IndexInfo.last_indexed_at:type_name -> google.protobuf.Timestamp
	66, // 2: weewar.v1.User.created_at:type_name -> google.protobuf.Timestamp
	66, // 3: weewar.v1.User.updated_at:type_name -> google.protobuf.Timestamp
	66, // 4: weewar.v1.World.created_at:type_name -> google.protobuf.Timestamp
	66, // 5: weewar.v1.World.updated_at:type_name -> google.protobuf.Timestamp
	...
	52, // 8: weewar.v1.WorldData.tiles_map:type_name -> weewar.v1.WorldData.TilesMapEntry
	53, // 9: weewar.v1.WorldData.units_map:type_name -> weewar.v1.WorldData.UnitsMapEntry
	4,  // 10: weewar.v1.WorldData.screenshot_index_info:type_name -> weewar.v1.IndexInfo
	54, // 11: weewar.v1.WorldData.crossings:type_name -> weewar.v1.WorldData.CrossingsEntry
	...
	55, // 14: weewar.v1.TerrainDefinition.unit_properties:type_name -> weewar.v1.TerrainDefinition.UnitPropertiesEntry
	56, // 15: weewar.v1.UnitDefinition.terrain_properties:type_name -> weewar.v1.UnitDefinition.TerrainPropertiesEntry
	57, // 16: weewar.v1.UnitDefinition.attack_vs_class:type_name -> weewar.v1.UnitDefinition.AttackVsClassEntry
	58, // 17: weewar.v1.UnitDefinition.action_limits:type_name -> weewar.v1.UnitDefinition.ActionLimitsEntry
	...
	59, // 20: weewar.v1.RulesEngine.units:type_name -> weewar.v1.RulesEngine.UnitsEntry
	60, // 21: weewar.v1.RulesEngine.terrains:type_name -> weewar.v1.RulesEngine.TerrainsEntry
	61, // 22: weewar.v1.RulesEngine.terrain_unit_properties:type_name -> weewar.v1.RulesEngine.TerrainUnitPropertiesEntry
	62, // 23: weewar.v1.RulesEngine.unit_unit_properties:type_name -> weewar.v1.RulesEngine.UnitUnitPropertiesEntry
	63, // 24: weewar.v1.RulesEngine.terrain_types:type_name -> weewar.v1.RulesEngine.TerrainTypesEntry
	66, // 25: weewar.v1.Game.created_at:type_name -> google.protobuf.Timestamp
	66, // 26: weewar.v1.Game.updated_at:type_name -> google.protobuf.Timestamp
	...
	66, // 33: weewar.v1.GameState.updated_at:type_name -> google.protobuf.Timestamp
	...
	64, // 36: weewar.v1.GameState.player_states:type_name -> weewar.v1.GameState.PlayerStatesEntry
	30, // 37: weewar.v1.GameMoveHistory.groups:type_name -> weewar.v1.GameMoveGroup
	66, // 38: weewar.v1.GameMoveGroup.started_at:type_name -> google.protobuf.Timestamp
	66, // 39: weewar.v1.GameMoveGroup.ended_at:type_name -> google.protobuf.Timestamp
	31, // 40: weewar.v1.GameMoveGroup.moves:type_name -> weewar.v1.GameMove
	66, // 41: weewar.v1.GameMove.timestamp:type_name -> google.protobuf.Timestamp
	33, // 42: weewar.v1.GameMove.move_unit:type_name -> weewar.v1.MoveUnitAction
	34, // 43: weewar.v1.GameMove.attack_unit:type_name -> weewar.v1.AttackUnitAction
	37, // 44: weewar.v1.GameMove.end_turn:type_name -> weewar.v1.EndTurnAction
	35, // 45: weewar.v1.GameMove.build_unit:type_name -> weewar.v1.BuildUnitAction
	36, // 46: weewar.v1.GameMove.capture_building:type_name -> weewar.v1.CaptureBuildingAction
	38, // 47: weewar.v1.GameMove.heal_unit:type_name -> weewar.v1.HealUnitAction
	39, // 48: weewar.v1.GameMove.changes:type_name -> weewar.v1.WorldChange
	32, // 49: weewar.v1.MoveUnitAction.from:type_name -> weewar.v1.Position
	32, // 50: weewar.v1.MoveUnitAction.to:type_name -> weewar.v1.Position
	51, // 51: weewar.v1.MoveUnitAction.reconstructed_path:type_name -> weewar.v1.Path
	32, // 52: weewar.v1.AttackUnitAction.attacker:type_name -> weewar.v1.Position
	32, // 53: weewar.v1.AttackUnitAction.defender:type_name -> weewar.v1.Position
	32, // 54: weewar.v1.BuildUnitAction.pos:type_name -> weewar.v1.Position
	32, // 55: weewar.v1.CaptureBuildingAction.pos:type_name -> weewar.v1.Position
	32, // 56: weewar.v1.HealUnitAction.pos:type_name -> weewar.v1.Position
	41, // 57: weewar.v1.WorldChange.unit_moved:type_name -> weewar.v1.UnitMovedChange
	42, // 58: weewar.v1.WorldChange.unit_damaged:type_name -> weewar.v1.UnitDamagedChange
	43, // 59: weewar.v1.WorldChange.unit_killed:type_name -> weewar.v1.UnitKilledChange
	44, // 60: weewar.v1.WorldChange.player_changed:type_name -> weewar.v1.PlayerChangedChange
	45, // 61: weewar.v1.WorldChange.unit_built:type_name -> weewar.v1.UnitBuiltChange
	46, // 62: weewar.v1.WorldChange.coins_changed:type_name -> weewar.v1.CoinsChangedChange
	47, // 63: weewar.v1.WorldChange.tile_captured:type_name -> weewar.v1.TileCapturedChange
	48, // 64: weewar.v1.WorldChange.capture_started:type_name -> weewar.v1.CaptureStartedChange
	40, // 65: weewar.v1.WorldChange.unit_healed:type_name -> weewar.v1.UnitHealedChange
	12, // 66: weewar.v1.UnitHealedChange.previous_unit:type_name -> weewar.v1.Unit
	12, // 67: weewar.v1.UnitHealedChange.updated_unit:type_name -> weewar.v1.Unit
	12, // 68: weewar.v1.UnitMovedChange.previous_unit:type_name -> weewar.v1.Unit
	12, // 69: weewar.v1.UnitMovedChange.updated_unit:type_name -> weewar.v1.Unit
	12, // 70: weewar.v1.UnitDamagedChange.previous_unit:type_name -> weewar.v1.Unit
	12, // 71: weewar.v1.UnitDamagedChange.updated_unit:type_name -> weewar.v1.Unit
	12, // 72: weewar.v1.UnitKilledChange.previous_unit:type_name -> weewar.v1.Unit
	12, // 73: weewar.v1.PlayerChangedChange.reset_units:type_name -> weewar.v1.Unit
	12, // 74: weewar.v1.UnitBuiltChange.unit:type_name -> weewar.v1.Unit
	12, // 75: weewar.v1.TileCapturedChange.capturing_unit:type_name -> weewar.v1.Unit
	12, // 76: weewar.v1.CaptureStartedChange.capturing_unit:type_name -> weewar.v1.Unit
	65, // 77: weewar.v1.AllPaths.edges:type_name -> weewar.v1.AllPaths.EdgesEntry
	50, // 78: weewar.v1.Path.edges:type_name -> weewar.v1.PathEdge
	3,  // 79: weewar.v1.Path.directions:type_name -> weewar.v1.PathDirection
	11, // 80: weewar.v1.WorldData.TilesMapEntry.value:type_name -> weewar.v1.Tile
	12, // 81: weewar.v1.WorldData.UnitsMapEntry.value:type_name -> weewar.v1.Unit
	10, // 82: weewar.v1.WorldData.CrossingsEntry.value:type_name -> weewar.v1.Crossing
	16, // 83: weewar.v1.TerrainDefinition.UnitPropertiesEntry.value:type_name -> weewar.v1.TerrainUnitProperties
	16, // 84: weewar.v1.UnitDefinition.TerrainPropertiesEntry.value:type_name -> weewar.v1.TerrainUnitProperties
	15, // 85: weewar.v1.RulesEngine.UnitsEntry.value:type_name -> weewar.v1.UnitDefinition
	14, // 86: weewar.v1.RulesEngine.TerrainsEntry.value:type_name -> weewar.v1.TerrainDefinition
	16, // 87: weewar.v1.RulesEngine.TerrainUnitPropertiesEntry.value:type_name -> weewar.v1.TerrainUnitProperties
	17, // 88: weewar.v1.RulesEngine.UnitUnitPropertiesEntry.value:type_name -> weewar.v1.UnitUnitProperties
	1,  // 89: weewar.v1.RulesEngine.TerrainTypesEntry.value:type_name -> weewar.v1.TerrainType
	27, // 90: weewar.v1.GameState.PlayerStatesEntry.value:type_name -> weewar.v1.PlayerState
	50, // 91: weewar.v1.AllPaths.EdgesEntry.value:type_name -> weewar.v1.PathEdge
...
func file_weewar_v1_models_models_proto_init() {
	if File_weewar_v1_models_models_proto != nil {
		return
	}
	...
	file_weewar_v1_models_models_proto_msgTypes[35].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_weewar_v1_models_models_proto_goTypes,
		DependencyIndexes: file_weewar_v1_models_models_proto_depIdxs,
		EnumInfos:         file_weewar_v1_models_models_proto_enumTypes,
		MessageInfos:      file_weewar_v1_models_models_proto_msgTypes,
	}.Build()
	File_weewar_v1_models_models_proto = out.File
	file_weewar_v1_models_models_proto_goTypes = nil
	file_weewar_v1_models_models_proto_depIdxs = nil
}
