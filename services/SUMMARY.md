...
- Datastore entity code in `gen/datastore/lilbattle/v1/datastore/` (generated by protoc-gen-dal)
- Datastore DAL code in `gen/datastore/dal/lilbattle/v1/datastore/`
- GORM entity code in `gen/gorm/lilbattle/v1/gorm/`
- GORM DAL code in `gen/gorm/dal/lilbattle/v1/gorm/`
