...
class MapEditorPage {
    ...
    initializeWasm() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const editorResult = window.editorCreate();
    ...
    createNewMap(width, height) {
        ...
        if (this.wasmInitialized) {
            try {
                const result = window.editorNewMap(height, width);
                if (result.success) {
    ...
    renderMapCanvas() {
        if (!this.mapCanvas || !this.wasmInitialized)
            return;
        try {
            const result = window.worldRendererRender('map-canvas', this.mapCanvas.width, this.mapCanvas.height);
            if (!result.success) {
...
//# sourceMappingURL=MapEditorPage.24d5de030d388e20b77d.js.map