(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["weewar"] = root["weewar"] || {}, root["weewar"]["MapDetailsPage"] = factory();
})(this, () => {
return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
/******/ 	var __webpack_modules__ = ({

/***/ "./frontend/components/MapDetailsPage.ts":
/*!***********************************************!*\
  !*** ./frontend/components/MapDetailsPage.ts ***!
  \***********************************************/
...
class MapDetailsPage {
    ...
    initializeComponents() {
        ...
        const mapId = (mapIdInput === null || mapIdInput === void 0 ? void 0 : mapIdInput.value.trim()) || null;
    ...
    loadInitialState() {
        ...
        if (mapId) {
            ...
            (_a = this.toastManager) === null || _a === void 0 ? void 0 : _a.showToast("Error", "Could not load document: Map ID missing.", "error");
        }
    }
    loadMapData(mapId) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["frontend_components_Modal_ts-frontend_components_ThemeManager_ts-frontend_components_ToastMan-fef01a"], () => (__webpack_require__("./frontend/components/MapDetailsPage.ts")))
...
//# sourceMappingURL=MapDetailsPage.0f11a6b1394e6ebe7c46.js.map