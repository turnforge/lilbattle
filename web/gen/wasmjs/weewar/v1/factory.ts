...
export class Weewar_v1Factory {
  ...
  /**
   * Enhanced factory method for MoveUnitAnimationRequest
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newMoveUnitAnimationRequest = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<MoveUnitAnimationRequestInterface> => {
    const out = new ConcreteMoveUnitAnimationRequest();
  ...
  /**
   * Enhanced factory method for MoveUnitAnimationResponse
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newMoveUnitAnimationResponse = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<MoveUnitAnimationResponseInterface> => {
    const out = new ConcreteMoveUnitAnimationResponse();
  ...
  /**
   * Enhanced factory method for SetUnitAtAnimationRequest
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newSetUnitAtAnimationRequest = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<SetUnitAtAnimationRequestInterface> => {
    const out = new ConcreteSetUnitAtAnimationRequest();
  ...
  /**
   * Enhanced factory method for SetUnitAtAnimationResponse
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newSetUnitAtAnimationResponse = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<SetUnitAtAnimationResponseInterface> => {
    const out = new ConcreteSetUnitAtAnimationResponse();
  ...
  /**
   * Enhanced factory method for RemoveUnitAtAnimationRequest
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newRemoveUnitAtAnimationRequest = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<RemoveUnitAtAnimationRequestInterface> => {
    const out = new ConcreteRemoveUnitAtAnimationRequest();
  ...
  /**
   * Enhanced factory method for RemoveUnitAtAnimationResponse
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newRemoveUnitAtAnimationResponse = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<RemoveUnitAtAnimationResponseInterface> => {
    const out = new ConcreteRemoveUnitAtAnimationResponse();
