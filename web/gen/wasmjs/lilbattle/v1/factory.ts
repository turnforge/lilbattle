 ...
 */
export class Lilbattle_v1Factory {
  ...
  /**
   * Enhanced factory method for Crossing
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
  ...
  newCrossing = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<CrossingInterface> => {
    const out = new ConcreteCrossing();
  ...
  /**
   * Enhanced factory method for PlayerState
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
  ...
  newPlayerState = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<PlayerStateInterface> => {
    const out = new ConcretePlayerState();
  ...
  /**
   * Enhanced factory method for HealUnitAction
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
  ...
  newHealUnitAction = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<HealUnitActionInterface> => {
    const out = new ConcreteHealUnitAction();
  ...
  /**
   * Enhanced factory method for FixUnitAction
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
  ...
  newFixUnitAction = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<FixUnitActionInterface> => {
    const out = new ConcreteFixUnitAction();
  ...
  /**
   * Enhanced factory method for UnitHealedChange
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
  ...
  newUnitHealedChange = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<UnitHealedChangeInterface> => {
    const out = new ConcreteUnitHealedChange();
  ...
  /**
   * Enhanced factory method for UnitFixedChange
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
  ...
  newUnitFixedChange = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<UnitFixedChangeInterface> => {
    const out = new ConcreteUnitFixedChange();
  ...
  /**
   * Enhanced factory method for TileCapturedChange
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newTileCapturedChange = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<TileCapturedChangeInterface> => {
    const out = new ConcreteTileCapturedChange();
  ...
  /**
   * Enhanced factory method for CaptureStartedChange
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newCaptureStartedChange = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<CaptureStartedChangeInterface> => {
    const out = new ConcreteCaptureStartedChange();
  ...
  /**
   * Enhanced factory method for SimulateFixRequest
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newSimulateFixRequest = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<SimulateFixRequestInterface> => {
    const out = new ConcreteSimulateFixRequest();
  ...
  /**
   * Enhanced factory method for SimulateFixResponse
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newSimulateFixResponse = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<SimulateFixResponseInterface> => {
    const out = new ConcreteSimulateFixResponse();
  ...
  /**
   * Enhanced factory method for ClientReadyRequest
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newClientReadyRequest = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<ClientReadyRequestInterface> => {
    const out = new ConcreteClientReadyRequest();
  ...
  /**
   * Enhanced factory method for ClientReadyResponse
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newClientReadyResponse = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<ClientReadyResponseInterface> => {
    const out = new ConcreteClientReadyResponse();
  ...
  /**
   * Enhanced factory method for ApplyRemoteChangesRequest
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newApplyRemoteChangesRequest = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<ApplyRemoteChangesRequestInterface> => {
    const out = new ConcreteApplyRemoteChangesRequest();
  ...
  /**
   * Enhanced factory method for ApplyRemoteChangesResponse
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newApplyRemoteChangesResponse = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<ApplyRemoteChangesResponseInterface> => {
    const out = new ConcreteApplyRemoteChangesResponse();
  ...
  getFactoryMethod(messageType: string): ((parent?: any, attributeName?: string, attributeKey?: string | number, data?: any) => FactoryResult<any>) | undefined {
    ...
    const currentPackage = "lilbattle.v1";
...
const DEFAULT_FACTORY = new Lilbattle_v1Factory();

/**
 * Schema-aware deserializer for lilbattle.v1 package
 * Extends BaseDeserializer with package-specific configuration
 */
export class Lilbattle_v1Deserializer extends BaseDeserializer {
  constructor(
    schemaRegistry = lilbattle_v1SchemaRegistry,
  ...
  static fromMsgType<T>(messageType: string, data: any): T {
    const deserializer = new Lilbattle_v1Deserializer(); // Uses default factory and schema registry
  ...
  static from<T>(typeConstructor: MessageTypeConstructor<T>, data: any): T {
    const deserializer = new Lilbattle_v1Deserializer();
