...
class GameInstanceDetailsPage {
    ...
    private currentGameInstanceId: string | null = null;
    private isLoadingGameInstance: boolean = false; // Loading state
    ...
    private loadInitialState(): void {
        ...
        if (designId) {
            ...
            this.toastManager?.showToast("Error", "Could not load document: GameInstance ID missing.", "error");
        }
    }
     ...
     */
    private async loadGameInstanceData(designId: string): Promise<void> {
